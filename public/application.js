...
/***/ function(module, exports, __webpack_require__) {
	...
	var bookEvents = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpFail = function signUpFail() {
	  $('#sign-up-prompt').text('Something\'s not right. Please Try Again!');
	};
	...
	var changePwFail = function changePwFail(data) {
	  $('#change-pw-prompt').text('Something\'s not right. Please Try Again!');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetBooks = function onGetBooks(event) {
	  event.preventDefault();
	  api.getBooks().then(ui.getBooksSuccess)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <!-- <tr data-id=\""
	    ...
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.grade_level : stack1), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</td>\n    <td>"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.reviews : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </td>\n  </tr>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n      "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.review_content : stack1), depth0))
	    + "\n";
	  ...
	  return "\n\n\n\n   <ul data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</li>\n"
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(5, data, 0, blockParams),"inverse":container.program(7, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.reviews : stack1),{"name":"if","hash":{},"fn":container.program(9, data, 0, blockParams),"inverse":container.program(11, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "   </ul>\n\n";
	  ...
	  return "         <li>"
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.reviews : stack1), depth0))
	    + "</li>\n";
	  ...
	  return "<div class=\"table-responsive\">\n  <table class=\"table table-hover\">\n<thead>\n  <tr>\n    <th>Title</th>\n    <th>Author</th>\n    <th>Grade Level</th>\n    <th>Description</th>\n    <th>Reviews</th>\n  </tr>\n</thead>\n<tbody>\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</tbody>\n\n  </table>\n</div>\n\n\n<!-- "
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreateReview = function onCreateReview(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.createReview(data).then(function (response) {
	    store.review = response.review;
	    return store.review;
	  }).then(ui.onCreateSuccess).catch(ui.onCreateError);
	};
	...
	var onShowReview = function onShowReview(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  var id = data.review.id;
	  api.showReview(id).then(ui.onShowSuccess).catch(ui.onError);
	};

	var onGetReviews = function onGetReviews(event) {
	  event.preventDefault();
	  api.indexReviews().then(ui.onSuccess).catch(ui.onError);
	};
	...
	var onUpdateReview = function onUpdateReview(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.updateReviews(data.review.id, data).then(ui.onUpdateReviewSuccess).catch(ui.onUpdateReviewError);
	};
	...
	var onDeleteReview = function onDeleteReview(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.destroyReviews(data.review.id).then(ui.onDeleteSuccess).catch(ui.onDeleteError);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateReviews = function updateReviews(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/reviews/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getReviewsHandlebars = __webpack_require__(38);
	var showReviewsHandlebars = __webpack_require__(39);

	var onSuccess = function onSuccess(data) {
	  console.table(data);
	  var getReviewsHtml = getReviewsHandlebars({ reviews: data.reviews });
	...
	var onShowSuccess = function onShowSuccess(data) {
	  ...
	  var showReviewsHtml = showReviewsHandlebars({ reviews: data.reviews });
	...
	var onUpdateReviewSuccess = function onUpdateReviewSuccess(data) {
	  if (data) {
	    console.log(data);
	...
	var onUpdateReviewError = function onUpdateReviewError(response) {
	  console.error(response);
	  $('#update-review')[0].reset();
	...
	module.exports = {
	  ...
	  onUpdateReviewError: onUpdateReviewError,
	  onDeleteError: onDeleteError,
	  onDeleteSuccess: onDeleteSuccess,
	  getReviewsHandlebars: getReviewsHandlebars,
	  showReviewsHandlebars: showReviewsHandlebars
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</th>\n    <td>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.review_content : stack1), depth0))
	    + "</td>\n    <td> "
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.books : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</td>\n  </tr>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n      "
	    + container.escapeExpression(container.lambda(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\n      ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
